  ...
  return (
    <PublicShell>
      <PolicyDocument
        title="개인정보처리방침"
        intro={
          '위로그(이하 "서비스")는 이용자의 개인정보를 소중하게 생각하며, 「개인정보 보호법」 등 관련 법령을 준수합니다. ' +
      ...
      >
        ...
        <PolicySection title="5. 광고 및 쿠키 (Google AdSense 고지)">
          ...
          <PolicyList
            items={[
              <>
                서비스는 처음 방문 시 하단 배너를 통해 광고·맞춤광고 쿠키 사용에 동의(또는
                필수만 허용)할지 선택하도록 안내합니다(Consent Mode). 선택 전까지 광고 관련
                저장소는 기본적으로 비활성화되며, 선택 내용은 브라우저에 저장되어 재방문 시
                다시 묻지 않습니다. 선택은 하단 푸터의 "쿠키 설정"에서 언제든 다시 열어 바꿀 수
                있습니다.
              </>,
              <>
