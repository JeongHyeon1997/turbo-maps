...
- [ ] (선택) 랜딩/정책 카피 오탈자·"about"성 설명 보강해 페이지 품질 올림. → **데이터 무관 콘텐츠 보강(FAQ·사용가이드·데이트 가이드 에디토리얼)은 `docs/plan/10-content.md`(A트랙)로 구체화** — STEP 0 실데이터 대기와 병행해 thin-content 리스크를 미리 완화.
